...
export class FogMap {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(FogMap.prototype);
        obj.__wbg_ptr = ptr;
        FogMapFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
     ...
     * @returns {Promise<any>}
     */
    static new_no_renderer() {
        const ret = wasm.fogmap_new_no_renderer();
        return ret;
    }
    /**
    ...
    add_fow_zip(data) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.fogmap_add_fow_zip(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {number} sw_x
     * @param {number} sw_y
     ...
     */
    get_bounding_mercator_pixels(sw_x, sw_y, ne_x, ne_y) {
        const ret = wasm.fogmap_get_bounding_mercator_pixels(this.__wbg_ptr, sw_x, sw_y, ne_x, ne_y);
     ...
     */
    render_image(view_x, view_y, zoom) {
        const ret = wasm.fogmap_render_image(this.__wbg_ptr, view_x, view_y, zoom);
        return ret;
    }
}
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_fogmap_new = function(arg0) {
        const ret = FogMap.__wrap(arg0);
        return ret;
    };
